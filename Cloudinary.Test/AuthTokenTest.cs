...
namespace Cloudinary.Test
{
    class AuthTokenTest : IntegrationTestBase
    {
        ...
        public void TestAuthenticatedUrl()
        {
            ...
            Assert.AreEqual("http://res.cloudinary.com/" + CloudinarySettings.Settings.CloudName + "/image/v1486020273?__cld_token__=st=11111111~exp=11111411~acl=*~hmac=67c908ea11bde7bced81926fe6dfa683f116a4f24714f150844b0160352588ba", url);
            ...
            Assert.AreEqual("http://res.cloudinary.com/" + CloudinarySettings.Settings.CloudName + "/image/v1486020273", url);
            ...
            Assert.AreEqual("http://res.cloudinary.com/" + CloudinarySettings.Settings.CloudName + "/image/c_scale,w_300/v1486020273?__cld_token__=st=222222222~exp=222222322~hmac=91f3401f8ff19755194b386010f3577a6d2fd7f72c44c793fa498419ad8633b6", url);
           ...
           //should compute expiration as start time + duration
            ...
            Assert.AreEqual("http://res.cloudinary.com/" + CloudinarySettings.Settings.CloudName + "/v1486020273/sample.jpg?__cld_token__=st=11111111~exp=11111411~hmac=a72618e343a488898732429b74e4a8cbb5767e2372421b8351d5381b8c6451ed", url);
        ...
        public void TestUrlInTag()
        {
            ...
            Assert.AreEqual("<img src=\"http://res.cloudinary.com/" + CloudinarySettings.Settings.CloudName + "/image/v1486020273/sample.jpg?__cld_token__=st=1111111111~exp=1111111411~acl=%2fimage%2f*~hmac=1751370bcc6cfe9e03f30dd1a9722ba0f2cdca283fa3e6df3342a00a7528cc51\"/>", url);
